...
d0=1;%diameter of the fracture,m
...
figure(1)
semilogx(f,v(1,:),'r','linewidth',1.5);
hold on;
semilogx(f,v(2,:),'g','linewidth',1.5);
hold on;
semilogx(f,v(3,:),'b','linewidth',1.5);
hold on;
semilogx(f,v(4,:),'k','linewidth',1.5);

xlabel('Frequency (Hz)','FontSize',12);
ylabel('{\itP}-wave velocity (m/s)','FontSize',12);
legend('{\ita}=0.50 m','{\ita}=0.35 m','{\ita}=0.25 m','{\ita}=0.15 m');
set(gca, 'FontSize', 12);
xlim([0.01 100000]);
set(gca,'XTick',[0.01 0.1 1 10 100 1000 10000 100000]);

figure(2)
loglog(f,inQ(1,:),'r','linewidth',1.5);
hold on;
loglog(f,inQ(2,:),'g','linewidth',1.5);
hold on;
loglog(f,inQ(3,:),'b','linewidth',1.5);
hold on;
loglog(f,inQ(4,:),'k','linewidth',1.5);
