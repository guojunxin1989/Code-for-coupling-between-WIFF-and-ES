...
hold on;
semilogx(f1,v1,'co','MarkerSize',6);
hold on;
...
legend('{\itc}{\rightarrow}0 m','Galvin results','{\itc}=0.005 m','{\itc}=0.020 m','{\itc}=0.035 m','{\itc}=0.050 m');
set(gca, 'FontSize', 12);
xlim([0.001 100000]);
...
hold on;
loglog(f1,inQ1,'co','MarkerSize',6);
hold on;
