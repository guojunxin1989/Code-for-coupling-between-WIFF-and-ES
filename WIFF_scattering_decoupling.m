...
perm=10^(-11);%permeability of background, m^2
b=vis/perm;
...
% load vWIFFfile v_WIFF;
% load inQWIFFfile inQ_WIFF;
% load vscafile v_sca;
% load inQscafile inQ_sca;

figure(1)
semilogx(f,v,'r','linewidth',1.5);
hold on;
semilogx(f,va3,'ro','MarkerSize',6);

xlabel('Frequency (Hz)','FontSize',12);
ylabel('{\itP}-wave velocity (m/s)','FontSize',12);
legend('Theoretical solution','Linear superposition');
set(gca, 'FontSize', 12);
xlim([10 100000]);
...
hold on;
loglog(f,inQa3,'ro','MarkerSize',6);
...
% figure(3)
% semilogx(F,v_WIFF,'r','linewidth',1.5);
% hold on;
% semilogx(F,v_sca,'g','linewidth',1.5);
% 
% xlabel('Frequency (Hz)','FontSize',12);
% ylabel('{\itP}-wave velocity (m/s)','FontSize',12);
% legend('WIFF','Scattering');
% set(gca, 'FontSize', 12);
% xlim([1 100000]);
% set(gca,'XTick',[1 10 100 1000 10000 100000]);
% 
% figure(4)
% loglog(F,inQ_WIFF,'r','linewidth',1.5);
% hold on;
% loglog(F,inQ_sca,'g','linewidth',1.5);
% 
% xlabel('Frequency (Hz)','FontSize',12);
% ylabel('{\itP}-wave attenuation','FontSize',12);
% legend('WIFF','Scattering');
% set(gca, 'FontSize', 12);
% xlim([1 100000]);
% set(gca,'XTick',[1 10 100 1000 10000 100000]);
